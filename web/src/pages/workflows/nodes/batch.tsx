  ...
  return (
    <>
      ...
      <div className="builder-row">
        ...
        <input className="input input--sm" value={String(node.body_node || "")} onChange={(e) => update({ body_node: e.target.value })} placeholder="process_item" />
      ...
      <div className="builder-row-pair">
        ...
        <div className="builder-row">
          ...
          <select className="input input--sm" value={String(node.on_item_error || "continue")} onChange={(e) => update({ on_item_error: e.target.value })}>
