      ...
      {is_custom && (
        <>
          <div className="builder-row-pair">
            <div className="builder-row">
              <label className="label">{t("workflows.oauth_auth_url") || "Auth URL"}</label>
            ...
            <div className="builder-row">
              <label className="label">{t("workflows.oauth_token_url") || "Token URL"}</label>
          ...
          <div className="builder-row-pair">
            <div className="builder-row">
              <label className="label">{t("workflows.oauth_client_id") || "Client ID"}</label>
            ...
            <div className="builder-row">
              <label className="label">{t("workflows.oauth_client_secret") || "Client Secret"}</label>
          ...
          <div className="builder-row">
            <label className="label">{t("workflows.oauth_scopes") || "Scopes"}</label>
