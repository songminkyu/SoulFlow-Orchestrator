 ...
 * - 기본 생성, GuardHandler/ToneHandler 조건부 포함
 * - McpHandler reconnect 로직
 * - AgentHandler deps (pick_subagent, cancel, send_input, get_running_count)
 * - ReloadHandler deps
...
import {
  ...
  ReloadHandler, StatsHandler, StopHandler, MemoryHandler,
  DecisionHandler, PromiseHandler, TaskHandler, StatusHandler,
  SkillHandler, DoctorHandler, VerifyHandler,
...
// ══════════════════════════════════════════════════════
// StatsHandler deps 람다 (reset_cd)
// ══════════════════════════════════════════════════════

describe("create_command_router — StatsHandler deps 람다 (reset_cd)", () => {
  it("reset_cd() → orchestration.reset_cd_score() 위임", () => {
