/**
 * RuntimeAdminTool 종합 커버리지 — skill/tool/mcp 관리 액션 전체.
 */
...
describe("RuntimeAdminTool — action 라우팅", () => {
...
describe("RuntimeAdminTool — skill_upsert", () => {
...
describe("RuntimeAdminTool — skill_list", () => {
...
describe("RuntimeAdminTool — tool_install_shell", () => {
  ...
  it("예약된 tool_name → Error", async () => {
    const r = await tool.execute({
      action: "tool_install_shell",
      tool_name: "reserved_tool",  // in list_registered_tool_names but not in dynamic tools
      tool_description: "desc",
      tool_command_template: "echo",
    });
    expect(r).toContain("Error");
...
describe("RuntimeAdminTool — tool_uninstall", () => {
  it("설치된 도구 삭제", async () => {
    // 먼저 설치
    await tool.execute({
      action: "tool_install_shell",
...
describe("RuntimeAdminTool — tool_list", () => {
...
describe("RuntimeAdminTool — mcp 서버 관리", () => {
...
describe("RuntimeAdminTool — validate_params", () => {
