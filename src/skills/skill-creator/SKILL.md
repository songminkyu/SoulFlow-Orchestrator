...
3. Initialize the skill directory and SKILL.md
4. Edit the skill (implement resources and write SKILL.md)
5. Validate and optionally package the skill
...
When creating a new skill from scratch, initialize the directory manually. Keep it minimal and deterministic.
...
After initialization, customize `SKILL.md` and add only required resources.
...
Once development of the skill is complete, validate it by loading it through `SkillsLoader` and running the project build.
...
```bash
cd skills && zip -r my-skill.zip my-skill
```

If validation fails, fix frontmatter or file structure and test again.
