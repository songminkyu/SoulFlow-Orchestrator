...
import type {
  ScopeType, Priority, RelationType,
  KanbanColumnDef, KanbanBoard, KanbanCard, KanbanComment, KanbanRelation,
  ActivityAction, KanbanActivity, KanbanRule, KanbanTemplate,
  ColumnDwellTime, CardTimeTracking, SearchResult, KanbanFilter, FilterCriteria,
  CreateBoardInput, CreateCardInput, UpdateCardInput,
