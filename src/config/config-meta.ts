...
export const CONFIG_FIELDS: ConfigFieldMeta[] = [
  ...
  { path: "orchestration.orchestratorProvider", label: "Orchestrator Provider", section: "orchestration", type: "select", env_key: "", default_value: "phi4_local", sensitive: false, restart_required: true, options: ["phi4_local", "openrouter", "chatgpt", "claude_code"], description: "LLM provider for orchestrator classification" },
  { path: "orchestration.executorProvider", label: "Executor Provider", section: "orchestration", type: "select", env_key: "", default_value: "chatgpt", sensitive: false, restart_required: true, options: ["chatgpt", "claude_code", "openrouter", "phi4_local"], description: "LLM provider for task execution" },
