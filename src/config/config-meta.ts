...
export const CONFIG_FIELDS: ConfigFieldMeta[] = [
  ...
  { path: "orchestration.orchestratorProvider", label: "Orchestrator Provider", section: "orchestration", type: "select", env_key: "", default_value: "", sensitive: false, restart_required: true, options: ["openrouter", "chatgpt", "claude_code", "claude_sdk", "codex_cli", "codex_appserver", "gemini_cli", "openai_compatible", "orchestrator_llm"], description: "LLM provider for orchestrator classification (set during setup)" },
  { path: "orchestration.executorProvider", label: "Executor Provider", section: "orchestration", type: "select", env_key: "", default_value: "", sensitive: false, restart_required: true, options: ["chatgpt", "claude_code", "claude_sdk", "codex_cli", "codex_appserver", "gemini_cli", "openrouter", "openai_compatible", "orchestrator_llm"], description: "LLM provider for task execution (set during setup)" },
