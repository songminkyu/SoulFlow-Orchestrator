...
import type { PtyFactory } from "./pty/types.js";
...
register_agent_provider_factory("container_cli", (config, _token, deps) => {
  ...
  // Docker Secrets: /run/secrets/ 에서 env 값 읽기
  ...
  // auth_profiles: [{ env: { ANTHROPIC_API_KEY: "sk-a" } }, { env: { ANTHROPIC_API_KEY: "sk-b" } }]
