...
export type AnyChannelSettings = SlackChannelSettings | TelegramChannelSettings | DiscordChannelSettings | MattermostChannelSettings | Record<string, unknown>;

export interface MattermostChannelSettings {
  default_channel?: string;
  api_base?: string;
  text_chunk_size?: number;
  text_file_fallback_threshold?: number;
  /** Interactive button callback URL (SoulFlow dashboard endpoint). */
  actions_url?: string;
}
